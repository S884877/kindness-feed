...
export default function BottomNav({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onShare}
        aria-label="join the kind collective"
        className="flex items-center gap-2 rounded-full px-4 -mt-3 active:scale-95 transition-transform"
        style={{
          height: '44px',
          background: 'linear-gradient(135deg, #cf7152, #b85a3e)',
          boxShadow: '0 6px 20px -2px rgba(184,90,62,0.55), 0 2px 8px rgba(184,90,62,0.2)',
          fontSize: '12px',
          fontWeight: 600,
          color: 'white',
          whiteSpace: 'nowrap',
